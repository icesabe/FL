...
parser.add_argument('--sampling', type=str, help="The sampling scheme used. sampling ∈ { random, importance, ours, dp, dp_comp_grads}")
...
parser.add_argument("--privacy", type=float, default=0.0, help="The parameter alpha used in dirichlet partition.")
...
parser.add_argument("--d_prime", type=int, default=10, help="The d_prime parameter (previously fixed at 2).")
