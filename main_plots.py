...
def main():
    ...
    plot_algorithm_comparison(results, args.partition, args.sample_ratio, dataset=args.dataset, skip_points=5) # Set skip_points to 1 if don't want to skip data points
